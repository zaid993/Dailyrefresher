package practice.JavaR.regular_Methods;
...
public class Unique {
    public static void main(String[] args) {
        ...
        //first find the frequency of 1 element so basically unique means occurred
        // 1 time take first element and compare it with the rest
